...
## Corpus Check
- 13 files · ~12,438 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 66 nodes · 76 edges · 6 communities detected
...
## Knowledge Gaps
- **Thin community `Community 4`** (6 nodes): `createShare()`, `getIncomingInvites()`, `getSentInvites()`, `listFiles()`, `registerSessionExpiredHandler()`, `api.ts`
