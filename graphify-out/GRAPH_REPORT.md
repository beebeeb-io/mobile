...
## Corpus Check
- 8050 files · ~7,461,447 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9520 nodes · 9904 edges · 201 communities detected
...
Cohesion: 0.01
Nodes (171): weak_ptr, facebook(), T(), facebook(), call(), callWithArgs(), callWithFunction(), callWithPriority() (+163 more)
...
Cohesion: 0.02
Nodes (85): facebook(), toJs(), Codable, BOOST_NOEXCEPT(), Decodable, fastIpv4AppendToString(), fastIpV4ToBufferUnsafe(), fastIpv4ToString() (+77 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (123): allocate_node(), BOOST_CATCH(), BOOST_TRY(), check_invariant_(), clear_(), construct_value(), copy_construct_from(), deallocate_node() (+115 more)
...
Cohesion: 0.02
Nodes (85): MUTEX_NAMESPACE(), attach(), check_outside_range(), check_same_owner(), check_valid_range(), detach(), detach_equivalent_iterators(), safe_container (+77 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (106): size_(), at(), back(), D_destroy_range_a(), D_uninitialized_fill_n_a(), dataIsInternal(), dataIsInternalAndNotVT(), end() (+98 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (70): facebook(), Allocator, CoreAllocatorGuard(), coreFree(), coreMalloc(), coreMallocFromGuard(), folly(), getSystemLocalityInfo() (+62 more)
...
Cohesion: 0.02
Nodes (61): impl(), mem_fn(), next(), facebook(), array_detail(), detail(), EmplaceBack(), folly() (+53 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (72): check(), max(), min(), computeInsertCapacity(), folly(), makeGuard(), facebook(), facebook() (+64 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (72): T(), archive_constructed(), call(), const_pow(), generate(), generate_from_int(), generate_from_real(), generate_impl() (+64 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (35): file_name(), function_name(), to_string(), facebook(), facebook(), find_format_all_copy_impl(), find_format_all_impl(), find_format_all_impl2() (+27 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (85): begin(), contains(), count(), end(), erase(), eraseInto(), eraseUnderlyingKey(), find() (+77 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (85): BignumDtoa(), BignumToFixed(), EstimatePower(), FixupMultiply10(), GenerateCountedDigits(), GenerateShortestDigits(), InitialScaledStartValues(), InitialScaledStartValuesNegativeExponentNegativePower() (+77 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (45): AUX_WRAPPER_NAME(), folly(), contains(), count(), find(), flat_map, flat_multimap, insert_or_assign() (+37 more)
...
Cohesion: 0.03
Nodes (53): BOOST_CORE_SWAP_NOEXCEPT_IF(), facebook(), adl_swap(), swap(), apply(), apply2(), integer_log2(), swap_() (+45 more)
...
Cohesion: 0.03
Nodes (43): folly(), facebook(), value(), common(), clear(), data(), dynamic_arg_list(), emplace() (+35 more)
...
Cohesion: 0.04
Nodes (29): uint32_t(), bigint(), pow10(), pow2(), pow5(), shl(), shl_bits(), shl_limbs() (+21 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (33): buffered_file(), close(), descriptor(), flush(), closeNoInt(), filterCloseReturn(), folly(), getIOVecFor() (+25 more)
...
- **Thin community `Community 75`** (12 nodes): `uniform_smallint.hpp`, `generate()`, `param_type`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.param_type()`, `uniform_smallint`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.uniform_smallint()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 76`** (12 nodes): `independent_bits.hpp`, `generate()`, `independent_bits_engine`, `.BOOST_RANDOM_DETAIL_ARITHMETIC_CONSTRUCTOR()`, `.BOOST_RANDOM_DETAIL_ARITHMETIC_SEED()`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_SEED_SEQ_CONSTRUCTOR()`, `.BOOST_RANDOM_DETAIL_SEED_SEQ_SEED()`, `.independent_bits_engine()`, `seed()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 77`** (12 nodes): `normal_distribution.hpp`, `generate_tail()`, `normal_distribution`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.normal_distribution()`, `param_type`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.param_type()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 78`** (12 nodes): `uniform_int_distribution.hpp`, `generate_uniform_int()`, `param_type`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.param_type()`, `uniform_int_distribution`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.uniform_int_distribution()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 79`** (11 nodes): `exponential_distribution.hpp`, `exponential_distribution`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.exponential_distribution()`, `param_type`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.param_type()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 80`** (11 nodes): `fisher_f_distribution.hpp`, `fisher_f_distribution`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.fisher_f_distribution()`, `param_type`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.param_type()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 82`** (11 nodes): `weibull_distribution.hpp`, `param_type`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.param_type()`, `weibull_distribution`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.weibull_distribution()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 83`** (11 nodes): `bernoulli_distribution.hpp`, `bernoulli_distribution`, `.bernoulli_distribution()`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `param_type`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.param_type()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 84`** (11 nodes): `piecewise_constant_distribution.hpp`, `param_type`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.param_type()`, `piecewise_constant_distribution`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.piecewise_constant_distribution()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 85`** (11 nodes): `extreme_value_distribution.hpp`, `extreme_value_distribution`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.extreme_value_distribution()`, `param_type`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.param_type()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 86`** (11 nodes): `non_central_chi_squared_distribution.hpp`, `non_central_chi_squared_distribution`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.non_central_chi_squared_distribution()`, `param_type`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.param_type()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 87`** (11 nodes): `student_t_distribution.hpp`, `param_type`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.param_type()`, `student_t_distribution`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.student_t_distribution()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 88`** (11 nodes): `uniform_on_sphere.hpp`, `param_type`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.param_type()`, `uniform_on_sphere`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.uniform_on_sphere()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 89`** (11 nodes): `beta_distribution.hpp`, `beta_distribution`, `.beta_distribution()`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `param_type`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.param_type()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 90`** (11 nodes): `laplace_distribution.hpp`, `laplace_distribution`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.laplace_distribution()`, `param_type`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.param_type()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 91`** (11 nodes): `cauchy_distribution.hpp`, `cauchy_distribution`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.cauchy_distribution()`, `param_type`, `.BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR()`, `.BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR()`, `.BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR()`, `.param_type()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 99`** (9 nodes): `folly()`, `grow_capacity_by()`, `reserve_if_available()`, `detail()`, `folly()`, `prepareDelim()`, `toOrIgnore()`, `Reserve.h`, `String-inl.h`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `move()` connect `Community 0` to `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 30`, `Community 34`, `Community 37`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `decltype()` connect `Community 12` to `Community 0`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 13`, `Community 14`, `Community 19`, `Community 20`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `Data` connect `Community 4` to `Community 12`, `Community 29`, `Community 7`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
